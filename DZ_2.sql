...
select customer_id, email, split_part(email, '@', 1) as email_1, split_part(email, '@', 2) as email_2 
from customer
...
select customer_id, email, concat(upper(substring(split_part(email, '@', 1),1,1)), lower(substring(split_part(email, '@', 1), 2))) as email_1, 
concat(upper(substring(split_part(email, '@', 2), 1, 1)), substring(split_part(email, '@', 2), 2)) as email_2
from customer